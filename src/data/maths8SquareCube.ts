...
export const MATHS8SC_SOLVED_QUESTIONS: NCERTSolvedQuestion[] = [
  ...
  },
  {
    ...
    question: "How many numbers lie between 12² and 13²?",
    given: { "First square": "12² = 144", "Second square": "13² = 169" },
    formulaUsed: "Between n² and (n+1)², there are always exactly 2n numbers.",
    derivationSteps: [
      "Here n = 12, so the number of numbers strictly between 12² and 13² is 2 x 12 = 24.",
    ...
    conceptualTip: "This pattern means the 'gap' between consecutive perfect squares keeps growing by 2 every time you move to the next pair -- between 1² and 2² there are 2 numbers, between 2² and 3² there are 4, and so on."
  },
  {
    id: 3,
    ...
    given: { "2m": "16, so m = 8" },
    formulaUsed: "For any m > 1, the three numbers (2m, m² - 1, m² + 1) always form a Pythagorean triple.",
    derivationSteps: [
      "m = 8, so 2m = 16.",
      "m² - 1 = 64 - 1 = 63.",
      "m² + 1 = 64 + 1 = 65.",
      "Check: 16² + 63² = 256 + 3969 = 4225, and 65² = 4225. They match."
    ],
  ...
  },
  {
    ...
    derivationSteps: [
      ...
      "So 1296 = 2⁴ x 3⁴ = (2 x 2 x 2 x 2) x (3 x 3 x 3 x 3).",
  ...
  },
  {
    ...
    derivationSteps: [
      ...
      "First pair is 32. The largest number whose square is at most 32 is 5 (5² = 25). Quotient so far: 5. Remainder: 32 - 25 = 7.",
  ...
  },
  {
    ...
    derivationSteps: [
      ...
      "180 x 5 = 900 = 2² x 3² x 5². sqrt(900) = 2 x 3 x 5 = 30."
    ],
  ...
  },
  {
    ...
    derivationSteps: [
      ...
      "Dividing by 3 removes exactly that one unpaired copy: 108 / 3 = 36 = 2² x 3².",
      "sqrt(36) = 2 x 3 = 6."
    ],
  ...
  },
  {
    ...
    derivationSteps: [
      "side = sqrt(2025).",
      "Factorize: 2025 = 3 x 3 x 3 x 3 x 5 x 5 = 3⁴ x 5².",
  ...
  },
  {
    ...
    derivationSteps: [
      ...
      "Multiplying by one more 2 fixes this: 500 x 2 = 1000 = 2³ x 5³.",
      "cbrt(1000) = 2 x 5 = 10."
    ],
  ...
  },
  {
    ...
    derivationSteps: [
      ...
      "So 15625 = 5⁶ = (5 x 5 x 5) x (5 x 5 x 5) -- two complete triples.",
      "Take one factor from each triple: 5 x 5 = 25."
    ],
    finalAnswer: "cbrt(15625) = 25.",
    conceptualTip: "A quick check: 25³ = 25 x 25 x 25 = 625 x 25 = 15625 -- always verify a cube root answer by cubing it back, exactly as this check does."
  },
  {
    id: 12,
    ...
    derivationSteps: [
      "edge = cbrt(13824).",
      "Factorize: 13824 = 2⁹ x 3³ (dividing by 2 nine times gives 27, which is 3³).",
  ...
  },
  {
    ...
    question: "Using the pattern that expresses a cube as a sum of consecutive odd numbers, write 6³ as such a sum, and verify the total.",
    given: { "Cube to express": "6³" },
    formulaUsed: "n³ can always be written as the sum of n consecutive odd numbers, where the first of these odd numbers is (n² - n + 1).",
    derivationSteps: [
      "For n = 6: first odd number = 6² - 6 + 1 = 36 - 6 + 1 = 31.",
      "The 6 consecutive odd numbers starting from 31 are: 31, 33, 35, 37, 39, 41.",
      "Sum = 31 + 33 + 35 + 37 + 39 + 41 = 216.",
      "Check: 6³ = 6 x 6 x 6 = 216. It matches."
    ],
    finalAnswer: "6³ = 31 + 33 + 35 + 37 + 39 + 41 = 216.",
    conceptualTip: "The number of terms in the sum always equals n itself (here, 6 terms for 6³) -- if your count of odd numbers doesn't match n, you've started from the wrong first odd number."
  },
  {
    id: 14,
    questionNumber: "Practice Q14",
    question: "Without actually cubing, find the last digit of 87³.",
    ...
    derivationSteps: [
      ...
      "From the fixed pairing, a number ending in 7 always produces a cube ending in 3 (since 7³ = 343, which ends in 3)."
    ],
    finalAnswer: "The last digit of 87³ is 3.",
...
export const MATHS8SC_MCQS: QuizQuestion[] = [
  ...
  { id: 3, question: "The square of an odd number is always:", options: ["Even", "Odd", "A multiple of 4", "Negative"], correctAnswer: 1, explanation: "An odd number squared is always odd -- for example, 7² = 49, which is odd." },
  { id: 4, question: "The square of an even number is always:", options: ["Odd", "Even", "A prime number", "Equal to itself"], correctAnswer: 1, explanation: "An even number squared is always even -- for example, 6² = 36, which is even." },
  ...
  { id: 6, question: "How many zeroes will 900² end with?", options: ["1", "2", "4", "3"], correctAnswer: 2, explanation: "900 ends in 2 zeroes, so 900² ends in exactly 2 x 2 = 4 zeroes (900² = 810000)." },
  ...
  { id: 8, question: "The sum of the first 9 odd natural numbers is:", options: ["45", "64", "81", "100"], correctAnswer: 2, explanation: "The sum of the first n odd numbers is n². Here n = 9, so the sum is 9² = 81." },
  { id: 9, question: "1 + 3 + 5 + 7 + 9 + 11 equals:", options: ["25", "36", "49", "64"], correctAnswer: 1, explanation: "There are 6 consecutive odd numbers here, so the sum is 6² = 36." },
  { id: 10, question: "How many non-square numbers lie between 15² and 16²?", options: ["15", "30", "31", "32"], correctAnswer: 1, explanation: "Between n² and (n+1)² there are always exactly 2n numbers. Here n = 15, so 2 x 15 = 30." },
  { id: 11, question: "Which set of three numbers (2m, m²-1, m²+1) is generated using m = 5?", options: ["(10, 24, 26)", "(8, 15, 17)", "(12, 35, 37)", "(6, 8, 10)"], correctAnswer: 0, explanation: "2m = 10, m²-1 = 24, m²+1 = 26 for m = 5. Check: 10² + 24² = 100 + 576 = 676 = 26²." },
  { id: 12, question: "Using m = 4 in the Pythagorean triple pattern (2m, m²-1, m²+1) gives:", options: ["(6, 8, 10)", "(8, 15, 17)", "(10, 24, 26)", "(4, 3, 5)"], correctAnswer: 1, explanation: "2m = 8, m²-1 = 15, m²+1 = 17. Check: 8² + 15² = 64 + 225 = 289 = 17²." },
  ...
  { id: 15, question: "Using prime factorization, sqrt(196) equals:", options: ["12", "13", "14", "16"], correctAnswer: 2, explanation: "196 = 2² x 7², so sqrt(196) = 2 x 7 = 14." },
  { id: 16, question: "Using prime factorization, sqrt(441) equals:", options: ["19", "20", "21", "22"], correctAnswer: 2, explanation: "441 = 3² x 7², so sqrt(441) = 3 x 7 = 21." },
  ...
  { id: 18, question: "What is the smallest number by which 72 must be multiplied to make it a perfect square?", options: ["2", "3", "4", "6"], correctAnswer: 0, explanation: "72 = 2³ x 3². The prime 2 has an odd exponent (3), while 3 already has an even exponent (2). Multiplying by 2 gives 2⁴ x 3² = 144 = 12², a perfect square." },
  { id: 19, question: "What is the smallest number by which 50 must be divided to make it a perfect square?", options: ["2", "5", "10", "25"], correctAnswer: 0, explanation: "50 = 2 x 5². The prime 2 has an odd exponent (1) and is unpaired. Dividing by 2 gives 25, a perfect square." },
  ...
  { id: 21, question: "Using the long division method, sqrt(1225) equals:", options: ["33", "34", "35", "36"], correctAnswer: 2, explanation: "Pairing 12|25: 3²=9 fits under 12 (remainder 3), bring down 25 to get 325; double 3 is 6, and 65 x 5 = 325 exactly, giving quotient 35." },
  ...
  { id: 24, question: "sqrt(90) lies between which two whole numbers?", options: ["8 and 9", "9 and 10", "10 and 11", "7 and 8"], correctAnswer: 1, explanation: "9² = 81 and 10² = 100, and 90 lies between them, so sqrt(90) lies between 9 and 10." },
  ...
  { id: 27, question: "The cube of a negative number is always:", options: ["Positive", "Negative", "Zero", "Undefined"], correctAnswer: 1, explanation: "A negative number cubed stays negative, since multiplying three negatives together gives a negative result: (-2)³ = -8." },
  { id: 28, question: "The cube of an even number is always:", options: ["Odd", "Even", "A perfect square too", "Negative"], correctAnswer: 1, explanation: "An even number cubed remains even -- for example, 4³ = 64." },
  { id: 29, question: "3³ is expressed as the sum of how many consecutive odd numbers?", options: ["2", "3", "4", "9"], correctAnswer: 1, explanation: "n³ is always the sum of exactly n consecutive odd numbers. For 3³, that is 3 odd numbers: 7 + 9 + 11 = 27." },
  { id: 30, question: "5³ is expressed as the sum of the 5 consecutive odd numbers starting at:", options: ["17", "19", "21", "23"], correctAnswer: 2, explanation: "The first odd number is n² - n + 1 = 25 - 5 + 1 = 21, giving 21+23+25+27+29 = 125 = 5³." },
  { id: 31, question: "A number ending in which digit can NEVER be a perfect cube ending?", options: ["2", "3", "Every digit 0-9 is possible for some perfect cube", "5"], correctAnswer: 2, explanation: "Unlike squares, EVERY digit 0-9 can be the last digit of some perfect cube (e.g. cubes ending in 2, 3, 7, 8 all genuinely occur, such as 12³ = 1728 ending in 8)." },
  { id: 32, question: "If a number ends in 8, its cube root (if it is a perfect cube) must end in:", options: ["2", "3", "7", "8"], correctAnswer: 0, explanation: "The fixed last-digit pairing for cubes matches 2 with 8 (since 2³ = 8), so a cube ending in 8 has a cube root ending in 2." },
  { id: 33, question: "If a number ends in 7, its cube root (if it is a perfect cube) must end in:", options: ["3", "7", "4", "9"], correctAnswer: 0, explanation: "The fixed pairing matches 3 with 7 (since 3³ = 27, ending in 7), so a cube ending in 7 has a cube root ending in 3." },
  { id: 34, question: "Using prime factorization, cbrt(1728) equals:", options: ["10", "11", "12", "13"], correctAnswer: 2, explanation: "1728 = 2⁶ x 3³ = (2x2x2) x (2x2x2) x (3x3x3), giving cube root 2 x 2 x 3 = 12." },
  { id: 35, question: "Using prime factorization, cbrt(9261) equals:", options: ["19", "20", "21", "22"], correctAnswer: 2, explanation: "9261 = 3³ x 7³, so cbrt(9261) = 3 x 7 = 21." },
  ...
  { id: 37, question: "What is the smallest number by which 88 must be multiplied to make it a perfect cube?", options: ["2", "11", "121", "22"], correctAnswer: 2, explanation: "88 = 2³ x 11¹. The exponent of 11 is 1, needing 2 more copies (to reach 3), so multiply by 11² = 121." },
  { id: 38, question: "What is the smallest number by which 250 must be multiplied to make it a perfect cube?", options: ["2", "4", "5", "10"], correctAnswer: 1, explanation: "250 = 2¹ x 5³. The exponent of 2 is 1, needing 2 more copies to reach 3, so multiply by 2² = 4." },
  { id: 39, question: "A cube-shaped box has volume 3375 cubic cm. Its edge length is:", options: ["12 cm", "13 cm", "14 cm", "15 cm"], correctAnswer: 3, explanation: "3375 = 3³ x 5³, so cbrt(3375) = 3 x 5 = 15." },
  ...
  { id: 44, question: "Which of these is NOT a perfect square?", options: ["361", "400", "450", "484"], correctAnswer: 2, explanation: "19² = 361, 20² = 400, and 22² = 484 are perfect squares, but 450 lies strictly between 21² = 441 and 22² = 484, so it is not one." },
  { id: 45, question: "Which of these is NOT a perfect cube?", options: ["512", "600", "729", "1000"], correctAnswer: 1, explanation: "8³ = 512, 9³ = 729, and 10³ = 1000 are perfect cubes, but 600 lies strictly between 8³ = 512 and 9³ = 729, so it is not one." },
  { id: 46, question: "If x² = 289, then x equals:", options: ["15", "16", "17", "18"], correctAnswer: 2, explanation: "17 x 17 = 289." },
  { id: 47, question: "If y³ = 4913, then y equals:", options: ["15", "16", "17", "18"], correctAnswer: 2, explanation: "17 x 17 x 17 = 4913." },
...
export const MATHS8SC_VERY_SHORT: ShortQuestion[] = [
  ...
  { id: 4, question: "State whether 4225 can be a perfect square, and why it can't be ruled out by its last digit alone.", answer: "It cannot be ruled out, since it ends in 5, one of the valid perfect-square endings (0,1,4,5,6,9). Checking further, 4225 = 65², so it IS a perfect square.", keyPoints: ["Ends in 5 (valid)", "4225 = 65 x 65"] },
  { id: 5, question: "Find the sum 1+3+5+7+9 using the odd-number-sum pattern.", answer: "There are 5 consecutive odd numbers, so the sum is 5² = 25.", keyPoints: ["5 terms", "Sum = 5² = 25"] },
  { id: 6, question: "How many numbers lie between 20² and 21²?", answer: "2 x 20 = 40 numbers.", keyPoints: ["Formula 2n", "n=20 gives 40"] },
  { id: 7, question: "Write the Pythagorean triple generated using m = 3 in (2m, m²-1, m²+1).", answer: "2m=6, m²-1=8, m²+1=10, giving the triple (6, 8, 10).", keyPoints: ["m=3", "(6,8,10)"] },
  { id: 8, question: "Verify that (9, 40, 41) is a Pythagorean triple.", answer: "9² + 40² = 81 + 1600 = 1681, and 41² = 1681. They match, so it is a valid triple.", keyPoints: ["81+1600=1681", "41²=1681"] },
  ...
  { id: 10, question: "Find sqrt(484) using prime factorization.", answer: "484 = 2² x 11², so sqrt(484) = 2 x 11 = 22.", keyPoints: ["484=2²x11²", "sqrt=22"] },
  { id: 11, question: "Find sqrt(676) using prime factorization.", answer: "676 = 2² x 13², so sqrt(676) = 2 x 13 = 26.", keyPoints: ["676=2²x13²", "sqrt=26"] },
  { id: 12, question: "Is 98 a perfect square? If not, find the smallest number to multiply it by to make it one.", answer: "98 = 2 x 7². The prime 2 is unpaired, so multiplying by 2 gives 196 = 14², a perfect square.", keyPoints: ["98=2x7²", "Multiply by 2 -> 196"] },
  { id: 13, question: "Is 75 a perfect square? If not, find the smallest number to divide it by to make it one.", answer: "75 = 3 x 5². The prime 3 is unpaired, so dividing by 3 gives 25 = 5², a perfect square.", keyPoints: ["75=3x5²", "Divide by 3 -> 25"] },
  { id: 14, question: "Estimate sqrt(70) between two consecutive whole numbers.", answer: "8² = 64 and 9² = 81, and 70 lies between them, so sqrt(70) is between 8 and 9.", keyPoints: ["64 < 70 < 81", "Between 8 and 9"] },
  ...
  { id: 17, question: "State the cube of -4.", answer: "(-4)³ = -4 x -4 x -4 = -64.", keyPoints: ["Negative cubed stays negative", "(-4)³=-64"] },
  { id: 18, question: "Express 4³ as the sum of consecutive odd numbers.", answer: "First odd number = 4²-4+1 = 13. The 4 consecutive odd numbers are 13+15+17+19 = 64 = 4³.", keyPoints: ["First term = 13", "13+15+17+19=64"] },
  { id: 19, question: "Without cubing, find the last digit of 63³.", answer: "63 ends in 3, and 3³ = 27 ends in 7, so 63³ ends in 7.", keyPoints: ["Last digit 3 -> cube ends in 7"] },
  { id: 20, question: "Without cubing, find the last digit of 124³.", answer: "124 ends in 4, and 4³ = 64 ends in 4, so 124³ ends in 4.", keyPoints: ["Last digit 4 -> cube ends in 4"] },
  { id: 21, question: "Find cbrt(2744) using prime factorization.", answer: "2744 = 2³ x 7³, so cbrt(2744) = 2 x 7 = 14.", keyPoints: ["2744=2³x7³", "cbrt=14"] },
  { id: 22, question: "Find cbrt(10648) using prime factorization.", answer: "10648 = 2³ x 11³, so cbrt(10648) = 2 x 11 = 22.", keyPoints: ["10648=2³x11³", "cbrt=22"] },
  { id: 23, question: "Is 120 a perfect cube? If not, find the smallest number to multiply it by to make it one.", answer: "120 = 2³ x 3 x 5. Both 3 and 5 have exponent 1 (need 2 more each), so multiply by 3² x 5² = 225 to get 27000, a perfect cube.", keyPoints: ["120=2³x3x5", "Multiply by 225 -> 27000"] },
  { id: 24, question: "A cube has volume 8000 cubic cm. Find its edge length.", answer: "8000 = 2⁶ x 5³, so cbrt(8000) = 2² x 5 = 20 cm.", keyPoints: ["cbrt(8000)=20"] },
  { id: 25, question: "How many perfect cubes lie strictly between 27 and 216?", answer: "The perfect cubes here are 64 (4³) and 125 (5³) -- that is 2 of them.", keyPoints: ["4³=64, 5³=125", "2 cubes"] },
  { id: 26, question: "State one number that is both a perfect square and a perfect cube, other than 1, and explain why.", answer: "64 is both, since 64 = 8² (a perfect square) and 64 = 4³ (a perfect cube). Any number that is a perfect sixth power (like 2⁶=64) is automatically both.", keyPoints: ["64=8² and 64=4³", "Perfect sixth powers work"] },
  { id: 27, question: "Find the square of 105 using the identity (a+b)² = a²+2ab+b², taking a=100, b=5.", answer: "105² = 100² + 2(100)(5) + 5² = 10000 + 1000 + 25 = 11025.", keyPoints: ["a=100,b=5", "11025"] },
  { id: 28, question: "Find the square of 98 using the identity (a-b)² = a²-2ab+b², taking a=100, b=2.", answer: "98² = 100² - 2(100)(2) + 2² = 10000 - 400 + 4 = 9604.", keyPoints: ["a=100,b=2", "9604"] },
  { id: 29, question: "Find sqrt(0.0016).", answer: "0.04 x 0.04 = 0.0016, so sqrt(0.0016) = 0.04.", keyPoints: ["0.04x0.04=0.0016"] },
  { id: 30, question: "A number when cubed gives a result ending in 5. What must the units digit of the original number be?", answer: "5, since 5³ = 125 also ends in 5, and 5 is the only digit that maps to itself under cubing in this way (checking all others confirms no other digit's cube ends in 5).", keyPoints: ["Units digit 5", "5³=125"] },
];

// ── SHORT (3 marks each) ──
export const MATHS8SC_SHORT: ShortQuestion[] = [
  { id: 1, question: "Find sqrt(3025) using the prime factorization method, showing the full factor tree.", answer: "3025 = 5 x 605 = 5 x 5 x 121 = 5 x 5 x 11 x 11 = 5² x 11². Pairing: (5x5)(11x11). sqrt(3025) = 5 x 11 = 55.", keyPoints: ["Factorize fully: 5² x 11²", "Pair identical primes", "sqrt = 5x11 = 55"] },
  { id: 2, question: "Find sqrt(7744) using the long division method, showing each step.", answer: "Pair as 77|44. Largest digit d with d² <= 77 is 8 (64), remainder 13. Bring down 44 to get 1344. Double 8 = 16; find x so (160+x)x <= 1344: x=8 gives 168x8=1344 exactly. Quotient = 88, remainder 0. sqrt(7744) = 88.", keyPoints: ["Pair digits: 77|44", "First digit 8, remainder 13", "Second digit 8, quotient 88"] },
  ...
  { id: 4, question: "A society wants to plant trees so that the number of rows equals the number of trees in each row, using exactly 1024 trees. How many rows will there be?", answer: "This means the number of rows, r, satisfies r x r = 1024, so r = sqrt(1024). Since 1024 = 2¹⁰ = (2⁵)², sqrt(1024) = 2⁵ = 32. There will be 32 rows.", keyPoints: ["Set up r² = 1024", "1024 = 2¹⁰", "r = 32"] },
  { id: 5, question: "Find the smallest 4-digit perfect square, and state its square root.", answer: "The smallest 4-digit number is 1000. sqrt(1000) is approximately 31.6, so try 32: 32² = 1024, which is the smallest 4-digit perfect square (31² = 961 is only 3 digits). Its square root is 32.", keyPoints: ["31²=961 (too small)", "32²=1024 (first 4-digit square)", "Square root is 32"] },
  { id: 6, question: "Find the largest 3-digit perfect square, and state its square root.", answer: "sqrt(999) is approximately 31.6, so try 31: 31² = 961, a 3-digit number. Check 32² = 1024, which is 4 digits, too big. So 961 is the largest 3-digit perfect square, with square root 31.", keyPoints: ["32²=1024 (too big)", "31²=961 (fits)", "Square root is 31"] },
  { id: 7, question: "Verify whether 3364 is a perfect square using prime factorization, and find its square root if so.", answer: "3364 = 2 x 1682 = 2 x 2 x 841 = 2 x 2 x 29 x 29 = 2² x 29². Every prime appears an even number of times, so it IS a perfect square. sqrt(3364) = 2 x 29 = 58.", keyPoints: ["Factorize: 2² x 29²", "All exponents even -> perfect square", "sqrt = 58"] },
  { id: 8, question: "Find the smallest number that must be added to 1780 to make it a perfect square.", answer: "sqrt(1780) is approximately 42.2, so check 42²=1764 and 43²=1849. Since 1780 is between these, the next perfect square above 1780 is 1849. Adding 1849-1780=69 gives the next perfect square.", keyPoints: ["42²=1764, 43²=1849", "1780 is between them", "Add 69 to reach 1849"] },
  { id: 9, question: "Find the largest number that must be subtracted from 1780 to make it a perfect square.", answer: "From the previous check, 42² = 1764, which is below 1780. Subtracting 1780-1764=16 brings it down exactly to the perfect square 1764.", keyPoints: ["42²=1764 (largest square below 1780)", "Subtract 16"] },
  { id: 10, question: "A gardener has 5000 plants and wants to plant them in rows such that the number of rows equals the number of columns. Find how many more plants are needed for this to be possible, or how many should be removed.", answer: "sqrt(5000) is approximately 70.7, so check 70²=4900 and 71²=5041. Since 5000 is closer to being reached by adding, the gardener needs 5041-5000=41 more plants to form a 71x71 square, OR could remove 5000-4900=100 plants to form a 70x70 square.", keyPoints: ["70²=4900, 71²=5041", "Add 41 for 71x71, or remove 100 for 70x70"] },
  { id: 11, question: "Show that 2³ + 3³ does NOT equal (2+3)³, and state the actual difference between them.", answer: "2³+3³ = 8+27 = 35. (2+3)³ = 5³ = 125. They are not equal; the difference is 125-35 = 90.", keyPoints: ["2³+3³=35", "(2+3)³=125", "Difference is 90"] },
  { id: 12, question: "Find cbrt(35937) using prime factorization, showing the full factor tree.", answer: "35937 = 3 x 11979 = 3 x 3 x 3993 = 3 x 3 x 3 x 1331 = 3³ x 11³ (since 1331 = 11x11x11). Grouping into triples: (3x3x3)(11x11x11). cbrt(35937) = 3 x 11 = 33.", keyPoints: ["Factorize: 3³ x 11³", "Group into triples", "cbrt = 3x11 = 33"] },
  { id: 13, question: "Is 200 a perfect cube? If not, find the smallest number to multiply it by to make it one, and state the resulting cube root.", answer: "200 = 2³ x 5². The exponent of 5 is 2, needing 1 more to reach 3. Multiplying by 5 gives 1000 = 2³ x 5³, a perfect cube. cbrt(1000) = 2 x 5 = 10.", keyPoints: ["200=2³x5²", "Multiply by 5 -> 1000", "cbrt(1000)=10"] },
  { id: 14, question: "Find the smallest number by which 192 must be divided to make it a perfect cube, and state the resulting cube root.", answer: "192 = 2⁶ x 3¹. The exponent of 3 is 1, which is not a multiple of 3 and cannot be reduced further by dividing without removing it entirely. Dividing by 3 gives 64 = 2⁶, and cbrt(64) = 2² = 4.", keyPoints: ["192=2⁶x3", "Divide by 3 -> 64", "cbrt(64)=4"] },
  { id: 15, question: "Express 7³ as a sum of consecutive odd numbers and verify the total.", answer: "First odd number = 7²-7+1 = 43. The 7 consecutive odd numbers are 43,45,47,49,51,53,55. Sum = 43+45+47+49+51+53+55 = 343 = 7³.", keyPoints: ["First term 43", "7 terms summing to 343"] },
  { id: 16, question: "A cube-shaped box has a volume of 21952 cubic cm. A second, similar box has 8 times this volume. Find the edge length of each box.", answer: "First box: 21952 = 2⁶ x 7³, cbrt = 2² x 7 = 28 cm. Second box's volume = 21952 x 8 = 175616 = 2⁹ x 7³, cbrt = 2³ x 7 = 56 cm.", keyPoints: ["First edge: 28 cm", "Volume x8 -> edge doubles", "Second edge: 56 cm"] },
  { id: 17, question: "Without fully calculating, determine whether 5³ + 6³ is greater than, less than, or equal to (5+6)³, and justify briefly.", answer: "5³+6³ = 125+216 = 341. (5+6)³ = 11³ = 1331. Since 341 < 1331, the sum of cubes is much less than the cube of the sum -- cubing a combined (larger) number grows far faster than adding two smaller cubes.", keyPoints: ["5³+6³=341", "11³=1331", "Sum of cubes is smaller"] },
  ...
  { id: 20, question: "Find the smallest square number divisible by each of the numbers 6, 9, and 15.", answer: "LCM of 6, 9, 15 = 90 = 2 x 3² x 5. The exponents of 2 and 5 are odd (1 each), so multiply by 2 x 5 = 10 to make every exponent even: 90 x 10 = 900 = 2² x 3² x 5², which is 30².", keyPoints: ["LCM(6,9,15)=90", "90=2x3²x5", "Multiply by 10 -> 900=30²"] },
];
...
export const MATHS8SC_LONG: LongQuestion[] = [
  {
    ...
    markingScheme: [
      ...
      "Finds the first quotient digit correctly (1, since 1²=1 fits under the first group '1', remainder 0)",
    ...
    answerParts: [
      ...
      { part: "Step 1", text: "First group is '1'. Largest digit d with d² <= 1 is 1 (1²=1). Quotient so far: 1. Remainder: 1-1=0." },
  ...
  },
  {
    ...
    answerParts: [
      { part: "Step 1: Find the side", text: "Side = sqrt(8836). Factorizing: 8836 = 2² x 47², so sqrt(8836) = 2 x 47 = 94 metres." },
  ...
  {
    id: 3,
    question: "Three consecutive natural numbers n-1, n, n+1 have the property that (n-1)(n+1) = n² - 1. Using this, find three consecutive natural numbers whose outer product is exactly 168, then verify the middle number's square is 169.",
    markingScheme: [
      "Correctly sets up the equation n² - 1 = 168",
      "Correctly solves n² = 169",
      ...
      "Verifies both that 12 x 14 = 168 AND that 13² = 169"
    ],
    answerParts: [
      { part: "Setting up", text: "Let the three consecutive numbers be n-1, n, n+1. Their outer product is (n-1)(n+1) = n² - 1." },
      { part: "Solving", text: "n² - 1 = 168, so n² = 169, giving n = 13 (the positive root, since these are natural numbers)." },
      { part: "The three numbers", text: "The three consecutive numbers are 12, 13, and 14." },
      { part: "Verification", text: "12 x 14 = 168, matching the given product. Also, 13² = 169, confirming the middle number's square is exactly one more than the outer product, as the identity predicts." },
      { part: "Final Answer", text: "The three numbers are 12, 13, and 14." }
    ]
  },
  {
    id: 4,
    question: "Using the pattern (2m, m²-1, m²+1) for generating Pythagorean triples, generate the triples for m = 7 and m = 9, and verify BOTH using the Pythagoras relation.",
    markingScheme: [
      "Correctly computes the triple for m=7: (14, 48, 50)",
      "Correctly verifies 14²+48²=50² for the first triple",
      "Correctly computes the triple for m=9: (18, 80, 82)",
      "Correctly verifies 18²+80²=82² for the second triple",
      "States both final triples clearly"
    ],
    answerParts: [
      { part: "For m=7", text: "2m = 14, m²-1 = 48, m²+1 = 50. Triple: (14, 48, 50)." },
      { part: "Verifying m=7", text: "14² + 48² = 196 + 2304 = 2500. 50² = 2500. They match." },
      { part: "For m=9", text: "2m = 18, m²-1 = 80, m²+1 = 82. Triple: (18, 80, 82)." },
      { part: "Verifying m=9", text: "18² + 80² = 324 + 6400 = 6724. 82² = 6724. They match." },
  ...
  },
  {
    ...
    answerParts: [
      { part: "Step 1: Find the LCM", text: "8 = 2³, 12 = 2² x 3, 15 = 3 x 5. LCM = 2³ x 3 x 5 = 120." },
      { part: "Step 2: Factorize the LCM", text: "120 = 2³ x 3¹ x 5¹." },
      ...
      { part: "Step 4: Find the multiplier", text: "Multiply by 2 x 3 x 5 = 30. 120 x 30 = 3600 = 2⁴ x 3² x 5²." },
      { part: "Final Answer", text: "The smallest such square number is 3600, and sqrt(3600) = 2² x 3 x 5 = 60." }
    ]
  },
  {
    id: 6,
    ...
    markingScheme: [
      "Correctly finds the volume of the cube: 12³ = 1728 cubic cm",
      "Correctly sets up the cuboid's dimensions as 2x, 3x, 4x for some x",
      "Correctly sets up the equation (2x)(3x)(4x) = 1728, simplifying to 24x³ = 1728",
      "Correctly solves for x³ = 72, and further simplification if needed to find x",
      "Correctly finds the final dimensions of the cuboid"
    ],
    answerParts: [
      { part: "Step 1: Volume of the cube", text: "Volume = 12³ = 1728 cubic cm." },
      { part: "Step 2: Set up the cuboid's dimensions", text: "Let the dimensions be 2x, 3x, and 4x. Volume = (2x)(3x)(4x) = 24x³." },
      { part: "Step 3: Equate volumes", text: "24x³ = 1728, so x³ = 72." },
      { part: "Step 4: Note on x", text: "72 is not a perfect cube (72 = 2³ x 3², and the exponent of 3 is not a multiple of 3), so x is not a whole number here -- the cuboid's dimensions in this exact ratio and this exact equal-volume condition come out as x = cube root of 72 (approximately 4.16), giving approximate dimensions 8.32 cm, 12.48 cm, and 16.64 cm." },
      { part: "Final Answer", text: "x = cbrt(72) (approximately 4.16 cm), giving approximate dimensions 8.32 cm x 12.48 cm x 16.64 cm; a genuinely whole-number answer would require the ratio or the cube's edge to be chosen so that x³ comes out as a perfect cube." }
    ]
  },
  {
    id: 7,
    ...
    answerParts: [
      ...
      { part: "First pair", text: "First group '1': largest d with d²<=1 is 1 (1²=1). Quotient so far: 1. Remainder: 0." },
  ...
  },
  {
    ...
    markingScheme: [
      ...
      "Correctly expands (n+1)² - n² using algebra",
    ...
    answerParts: [
      ...
      { part: "Expanding the difference of squares", text: "(n+1)² - n² = (n² + 2n + 1) - n² = 2n + 1." },
      ...
      { part: "Verifying with 45 and 46", text: "46² - 45² = 2116 - 2025 = 91. Sum: 45 + 46 = 91. They match exactly." },
  ...
  {
    id: 9,
    question: "A number N, when expressed as a product of primes, is 2⁴ x 3² x 5⁶ x 7³. Determine whether N is a perfect square, a perfect cube, both, or neither, giving full reasoning, and state the smallest number by which N must be multiplied to make it BOTH a perfect square and a perfect cube (i.e. a perfect sixth power).",
    markingScheme: [
    ...
    answerParts: [
      { part: "Checking perfect square", text: "N = 2⁴ x 3² x 5⁶ x 7³. For a perfect square, every exponent must be even. Here 4, 2, and 6 are even, but 3 (on the 7) is odd -- so N is NOT a perfect square." },
      ...
      { part: "Making it a perfect sixth power", text: "For N to be both simultaneously, every exponent must be a multiple of 6 (the LCM of 2 and 3). Currently: 2 needs 2 more (4->6), 3 needs 4 more (2->6), 5 already has 6 (fine), 7 needs 3 more (3->6). Multiply by 2² x 3⁴ x 7³ = 4 x 81 x 343 = 111132." },
      { part: "Final Answer", text: "N is neither a perfect square nor a perfect cube. The smallest number to multiply by to make it a perfect sixth power (both at once) is 2² x 3⁴ x 7³ = 111132." }
    ]
  },
  {
    id: 10,
    ...
    answerParts: [
      { part: "Step 1: Ratio of sides", text: "Since area is proportional to (side)², if areas are in ratio 25:64, sides are in ratio sqrt(25):sqrt(64) = 5:8." },
  ...
  },
  {
    ...
    markingScheme: [
      ...
      "Correctly identifies 274625 = 5³ x 13³",
    ...
    answerParts: [
      ...
      { part: "Prime factorization", text: "274625 = 5 x 5 x 5 x 13 x 13 x 13 = 5³ x 13³." },
      ...
      { part: "Final Answer", text: "cbrt(274625) = 65. Verification: 65³ = 65 x 65 x 65 = 4225 x 65 = 274625, confirming the answer." }
    ]
  },
  {
    id: 12,
    ...
    answerParts: [
      ...
      { part: "Step 2: Work with a scaled whole number", text: "42.875 = 42875/1000. Since 1000 = 10³, cbrt(42.875) = cbrt(42875)/10." },
      { part: "Step 3: Factorize 42875", text: "42875 = 5³ x 7³ (since 42875 / 5 = 8575, /5 = 1715, /5 = 343 = 7³)." },
  ...
  {
    id: 13,
    question: "Prove, using algebra, that the sum of the cubes of the first n natural numbers equals the square of their sum, i.e. 1³+2³+...+n³ = (1+2+...+n)², by verifying it for n=4 and stating the general formula.",
    markingScheme: [
      ...
      "Correctly computes 10² = 100 and confirms the match",
    ...
    answerParts: [
      ...
      { part: "For n=4: sum of cubes", text: "1³+2³+3³+4³ = 1+8+27+64 = 100." },
      { part: "Comparing", text: "10² = 100, which exactly equals the sum of the cubes." },
      { part: "Final Answer", text: "This confirms the identity 1³+2³+3³+4³ = (1+2+3+4)² = 100 for n=4, and in general, the sum of the first n cubes always equals the square of the sum of the first n natural numbers, i.e. [n(n+1)/2]²." }
    ]
  },
  {
    id: 14,
    ...
    markingScheme: [
      "Correctly identifies the two nearest perfect cubes surrounding 5607 (17³ and 18³)",
      "Correctly computes 17³ = 4913 and 18³ = 5832",
    ...
    answerParts: [
      { part: "Step 1: Find nearby cubes", text: "17³ = 4913 and 18³ = 5832. 5607 lies between these two." },
      ...
      { part: "Final Answer", text: "Subtracting 694 from 5607 gives 4913, which is a perfect cube (17³), with cube root 17." }
    ]
  },
  {
    id: 15,
    ...
    answerParts: [
      ...
      { part: "Final Answer", text: "Adding 225 to 5607 gives 5832, which is a perfect cube (18³), with cube root 18." }
    ]
  },
  {
    id: 16,
    ...
    markingScheme: [
      ...
      "Correctly finds the first quotient digit for the integer part (3, since 3²=9 exactly)",
    ...
    answerParts: [
      ...
      { part: "Integer part", text: "Largest d with d²<=9 is 3 (exactly 9). Remainder 0. Quotient so far: 3." },
  ...
  },
  {
    ...
    markingScheme: [
      "Correctly counts the perfect squares from 1² up to the largest below 1000 (31²=961)",
      "Correctly counts the perfect cubes from 1³ up to the largest below 1000 (9³=729)",
      "Correctly identifies that a number which is both must be a perfect sixth power",
      "Correctly finds the perfect sixth powers in range: 1⁶=1 and 2⁶=64 (3⁶=729 also qualifies)",
      "States all three final counts clearly"
    ],
    answerParts: [
      { part: "Counting perfect squares", text: "1² through 31² (961) are all under 1000 (32²=1024 exceeds it). That is 31 perfect squares." },
      { part: "Counting perfect cubes", text: "1³ through 9³ (729) are all under 1000 (10³=1000 is included if inclusive, or excluded if strictly under). Taking 1 to 999, that is 9 perfect cubes (1 through 729); if 1000 itself is included, that is 10." },
      { part: "Numbers that are both", text: "A number that is both a perfect square and a perfect cube must be a perfect sixth power. 1⁶=1, 2⁶=64, 3⁶=729 -- all under 1000. 4⁶=4096, too big." },
  ...
  },
  {
    ...
    markingScheme: [
      ...
      "Correctly sets up the equation for the difference of squares: (9x)² - (4x)² = 260",
      "Correctly simplifies to 81x² - 16x² = 65x² = 260",
      "Correctly solves x² = 4, giving x = 2",
      "Correctly computes the final two numbers"
    ],
    answerParts: [
      { part: "Step 1: Set up variables", text: "Let the numbers be 4x and 9x." },
      { part: "Step 2: Set up the difference of squares", text: "(9x)² - (4x)² = 81x² - 16x² = 65x²." },
      { part: "Step 3: Solve for x", text: "65x² = 260, so x² = 4, giving x = 2 (taking the positive root)." },
      { part: "Step 4: Compute the numbers", text: "The two numbers are 4(2)=8 and 9(2)=18." },
      { part: "Final Answer", text: "The two numbers are 8 and 18. Check: 18² - 8² = 324 - 64 = 260, matching the given difference." }
    ]
  },
  {
    id: 20,
    ...
    answerParts: [
      { part: "Step 1: Find the LCM", text: "4 = 2², 6 = 2 x 3, 10 = 2 x 5. LCM = 2² x 3 x 5 = 60." },
      { part: "Step 2: Factorize the LCM", text: "60 = 2² x 3¹ x 5¹." },
      ...
      { part: "Step 4: Find the multiplier", text: "Multiply by 2¹ x 3² x 5² = 2 x 9 x 25 = 450. 60 x 450 = 27000 = 2³ x 3³ x 5³." },
      { part: "Final Answer", text: "The least perfect cube divisible by 4, 6, and 10 is 27000 (which is 30³)." }
    ]
  },
];
...
export const MATHS8SC_COMPETENCY: CompetencyQuestion[] = [
  {
    ...
    subQuestions: [
      { question: "What must be true about 5776 for a square park to exactly use up the land?", answer: "5776 must be a perfect square, since the area of a square is (side)², and side must be a whole number of metres for practical construction." },
      { question: "Find the side length of the park.", answer: "sqrt(5776) = 76 metres, since 5776 = 2⁴ x 19², giving sqrt = 2² x 19 = 76.", options: ["72 m", "74 m", "76 m", "78 m"], correctIndex: 2 },
  ...
  },
  {
    ...
    subQuestions: [
      { question: "Find the edge length of the crate.", answer: "5832 = 2³ x 3⁶ = 18³ (since 18 = 2 x 3²), so the edge is 18 cm.", options: ["16 cm", "17 cm", "18 cm", "19 cm"], correctIndex: 2 },
      { question: "The warehouse wants a bigger crate with exactly 8 times the volume. Find the new crate's volume and edge length.", answer: "New volume = 5832 x 8 = 46656 cubic cm. Since volume scales as (edge)³, and 8=2³, the new edge = 18 x 2 = 36 cm." },
      ...
      { question: "Explain why doubling a cube's edge length results in 8 times the volume, not 2 times.", answer: "Volume of a cube is edge³. Doubling the edge means (2 x edge)³ = 8 x edge³, since the multiplier 2 gets cubed too -- so volume scales by the CUBE of the scale factor, not the scale factor itself." }
    ]
  },
  {
    id: 3,
    ...
    subQuestions: [
      { question: "Is 2025 a perfect square? Justify using prime factorization.", answer: "2025 = 3⁴ x 5² = (3x3)x(3x3)x(5x5), all exponents even, so yes, 2025 is a perfect square." },
      { question: "How many students will stand in each row?", answer: "sqrt(2025) = 3² x 5 = 45 students per row.", options: ["40", "43", "45", "48"], correctIndex: 2 },
      { question: "If 4 more students join and the school wants to keep it a perfect square formation with everyone included, how many more students beyond those 4 (if any) are needed?", answer: "2025 + 4 = 2029. The next perfect square after 2025 (45²) is 46² = 2116. So 2116 - 2029 = 87 more students are needed beyond the initial 4 to reach the next full square formation." },
  ...
  },
  {
    ...
    caseDescription: "A mathematics club builds a simple 'machine' (a formula) that takes any whole number m greater than 1 and outputs the three numbers (2m, m²-1, m²+1), which always form a Pythagorean triple.",
    subQuestions: [
      { question: "Run the machine with m = 6. What three numbers come out?", answer: "2m=12, m²-1=35, m²+1=37. Output: (12, 35, 37)." },
      { question: "Verify the output from m=6 is a genuine Pythagorean triple.", answer: "12²+35² = 144+1225 = 1369. 37² = 1369. They match, confirming a valid triple." },
      { question: "A student runs the machine and gets the output (2m, 24, 26) but has forgotten the value of m used. Find m.", answer: "Since m²+1=26, m²=25, so m=5 (taking the positive root). Check: 2m=10, m²-1=24 -- matches the given 24.", options: ["4", "5", "6", "7"], correctIndex: 1 },
      { question: "Explain, in your own words, why this machine's formula always produces a valid Pythagorean triple for any m > 1 (no need for full algebraic proof, just the key algebraic idea).", answer: "The key idea is that (2m)² + (m²-1)² always simplifies algebraically to exactly (m²+1)² -- expanding both sides shows the middle terms cancel out perfectly, so the relationship holds for every value of m, not just specific numbers checked by trial." }
    ]
  },
  {
    id: 5,
    ...
    subQuestions: [
      { question: "Find the edge length of the box using prime factorization.", answer: "4096 = 2¹², so cbrt(4096) = 2⁴ = 16 cm.", options: ["14 cm", "15 cm", "16 cm", "17 cm"], correctIndex: 2 },
      { question: "The bakery also sells a 'mini' version with exactly 1/8 the volume. Find the mini box's edge length.", answer: "Mini volume = 4096/8 = 512 cubic cm. Since volume scales as edge³ and 1/8 = (1/2)³, mini edge = 16/2 = 8 cm." },
      { question: "If the bakery wants a 'jumbo' box with 27 times the original volume, find the jumbo box's edge length.", answer: "27 = 3³, so jumbo edge = 16 x 3 = 48 cm (since volume scaling by 3³ means edge scales by 3)." },
      { question: "Explain why a box with exactly double the ORIGINAL box's edge length does NOT have double the volume.", answer: "Volume = edge³, so doubling the edge multiplies volume by 2³ = 8, not by 2 -- the cubic relationship means small changes in edge length cause much bigger changes in volume." }
    ]
  },
  {
    id: 6,
    ...
    subQuestions: [
      { question: "Estimate sqrt(130) to the nearest whole number.", answer: "11²=121 and 12²=144. 130 is closer to 121 (difference 9) than to 144 (difference 14), so sqrt(130) is approximately 11 (more precisely about 11.4)." },
      { question: "Estimate sqrt(300) to the nearest whole number.", answer: "17²=289 and 18²=324. 300 is closer to 289 (difference 11) than to 324 (difference 24), so sqrt(300) is approximately 17 (more precisely about 17.3)." },
  ...
  },
  {
    ...
    caseDescription: "For a competition, students are asked to explore the pattern where n³ is written as a sum of n consecutive odd numbers.",
    subQuestions: [
      { question: "Write 5³ as a sum of 5 consecutive odd numbers.", answer: "First term = 5²-5+1 = 21. The sum is 21+23+25+27+29 = 125 = 5³." },
      { question: "A student claims 8³ can be written using odd numbers starting from 57. Verify if this is correct.", answer: "The correct first term for n=8 is 8²-8+1 = 57. The student is correct: the 8 consecutive odd numbers are 57,59,61,63,65,67,69,71, summing to 512 = 8³." },
      { question: "Verify the sum from the previous question equals exactly 512.", answer: "57+59+61+63+65+67+69+71 = 512, matching 8³ = 8x8x8 = 512." },
      { question: "Without computing the full sum, explain how you know in advance that exactly 8 odd numbers should be added for 8³ (not 7 or 9).", answer: "The rule states n³ is the sum of exactly n consecutive odd numbers -- since we are computing 8³, the number n itself is 8, so exactly 8 terms must be used, no more and no fewer." }
    ]
  },
  {
    id: 8,
    ...
    subQuestions: [
      { question: "Find the side length of the pool.", answer: "sqrt(1156) = 34 metres, since 1156 = 2² x 17².", options: ["32 m", "33 m", "34 m", "35 m"], correctIndex: 2 },
      ...
      { question: "The centre later decides to extend the pool so its area becomes exactly 4 times the original. Find the new side length.", answer: "New area = 1156 x 4 = 4624. Since area scales by 4 = 2², side scales by 2: new side = 34 x 2 = 68 metres." },
      { question: "Explain, using the idea of scaling, why quadrupling the AREA of a square only doubles its SIDE length, rather than also quadrupling it.", answer: "Area = side², a squared relationship -- to quadruple the area (multiply by 4 = 2²), the side only needs to be multiplied by 2, since squaring that factor of 2 gives the required factor of 4 in area." }
    ]
  },
  {
    id: 9,
    ...
    subQuestions: [
      ...
      { question: "Verify that (9, 12, 15) is a valid Pythagorean triple.", answer: "9²+12² = 81+144 = 225. 15² = 225. They match, confirming a valid right-angle triple." },
      ...
      { question: "Suggest a different, larger Pythagorean triple (not just a multiple of 3-4-5) the worker could use if the walls happen to be longer, using the (2m, m²-1, m²+1) pattern with m=10.", answer: "For m=10: 2m=20, m²-1=99, m²+1=101, giving the triple (20, 99, 101)." }
    ]
  },
  {
    id: 10,
    ...
    subQuestions: [
      { question: "Is 1444 a perfect square? Show the factorization.", answer: "1444 = 2² x 19², all exponents even -- yes, it is a perfect square, and sqrt(1444) = 2 x 19 = 38." },
      { question: "Is 1521 a perfect square? Show the factorization.", answer: "1521 = 3² x 169 = 3² x 13², all exponents even -- yes, it is a perfect square, and sqrt(1521) = 3 x 13 = 39." },
      { question: "Is 1458 a perfect square? Show the factorization and explain your conclusion.", answer: "1458 = 2 x 729 = 2 x 3⁶. The exponent of 2 is 1 (odd) -- so 1458 is NOT a perfect square, since not every prime factor is paired.", options: ["Yes", "No", "Cannot be determined", "Only if rounded"], correctIndex: 1 },
  ...
  },
  {
    ...
    subQuestions: [
      { question: "Is 3375 a perfect cube? Show using prime factorization.", answer: "3375 = 3³ x 5³, both exponents multiples of 3 -- yes, it is a perfect cube." },
      ...
      { question: "If the student has 50 more cubes (3425 total) and wants to form the next possible bigger perfect cube, will 3425 work directly, or how many more/fewer are needed?", answer: "The next perfect cube after 15³=3375 is 16³=4096. 3425 is not a perfect cube, so the student needs 4096-3425=671 more cubes to reach the next full cube shape (16 along each edge)." },
      { question: "Alternatively, could the student remove cubes from 3425 to reach the PREVIOUS perfect cube instead? How many would need to be removed?", answer: "The previous perfect cube is 15³=3375. Removing 3425-3375=50 cubes (exactly the 50 extra ones) would bring it back to a valid cube shape." }
    ]
  },
  {
    id: 12,
    ...
    subQuestions: [
      { question: "Confirm 1089 is a perfect square and find the grid's dimensions (rows x columns).", answer: "1089 = 3² x 11², so sqrt(1089) = 3 x 11 = 33. The grid is 33 x 33 panels." },
      ...
      { question: "The team wants to expand the grid to a 40 x 40 arrangement. How many additional panels are needed?", answer: "New total = 40² = 1600. Additional panels needed = 1600 - 1089 = 511." },
      { question: "Explain why a 'square grid' arrangement (equal rows and columns) requires the total panel count to be a perfect square, using the definition of area.", answer: "A grid of r rows and c columns has r x c total panels; for the grid to be square-shaped, rows must equal columns (r=c), so the total becomes r x r = r² -- a perfect square by definition." }
    ]
  },
  {
    id: 13,
    ...
    subQuestions: [
      { question: "Complete Aisha's method: factorize 2116 into primes.", answer: "2116 = 2² x 23²." },
  ...
  },
  {
    ...
    subQuestions: [
      { question: "Using the trick, find the last digit of the cube root of 175616.", answer: "175616 ends in 6, and the pairing rule matches 6 with 6 (since 6³=216 ends in 6), so the cube root ends in 6." },
      { question: "Group 175616 into sets of three from the right, and use the LEFT group to estimate the first digit of the cube root.", answer: "Grouping: 175 | 616. The left group is 175. Since 5³=125 and 6³=216, and 175 lies between them, the first digit of the cube root is 5 (the cube root of the left group's 'bracket', taking the smaller one)." },
      ...
      { question: "Verify that 56³ = 175616.", answer: "56³ = 56 x 56 x 56 = 3136 x 56 = 175616, confirming the trick's answer is correct." }
    ]
  },
  {
    id: 15,
    ...
    subQuestions: [
      { question: "Find the side length of the original square fabric.", answer: "sqrt(2916) = 54 cm, since 2916 = 2² x 3⁶ = (2x3³)² = 54².", options: ["52 cm", "53 cm", "54 cm", "55 cm"], correctIndex: 2 },
  ...
  },
  {
    ...
    caseDescription: "A science club notices that the number of odd numbers needed to build up to a given square number follows a clean pattern, and wants to use it to solve a puzzle involving 20².",
    subQuestions: [
      { question: "How many consecutive odd numbers (starting from 1) are needed to sum to exactly 400?", answer: "Since 400 = 20², exactly 20 consecutive odd numbers (starting from 1) are needed." },
      ...
      { question: "Verify that the sum of odd numbers from 1 to 39 equals 400.", answer: "The sum of the first 20 odd numbers is 20² = 400, and the sequence 1,3,5,...,39 has exactly 20 terms, confirming the total is 400." },
      { question: "If the club instead wanted a sum of exactly 361, how many consecutive odd numbers (from 1) would they need, and what would be the last one?", answer: "361 = 19², so 19 consecutive odd numbers are needed, with the last one being 2(19)-1 = 37." }
    ]
  },
  {
    id: 17,
    ...
    subQuestions: [
      { question: "If the smaller tank has an edge of 5 metres, find its volume.", answer: "Volume = 5³ = 125 cubic metres." },
      { question: "Find the volume of the larger tank.", answer: "Larger volume = 125 x 64 = 8000 cubic metres." },
      { question: "Find the edge length of the larger tank using the cube root of its volume.", answer: "cbrt(8000) = 20 metres (since 8000 = 2⁶ x 5³, cbrt = 2² x 5 = 20).", options: ["18 m", "19 m", "20 m", "21 m"], correctIndex: 2 },
  ...
  },
  {
    ...
    subQuestions: [
      { question: "Find the number of squares along one side of the grid.", answer: "sqrt(1600) = 40, since 1600 = 2⁶ x 5² = (2³ x 5)² = 40².", options: ["38", "39", "40", "41"], correctIndex: 2 },
      { question: "If the grid is extended so that it has 100 more small squares in total along both dimensions equally (still remaining a perfect square grid), what is the smallest new total that fits this description?", answer: "The next perfect square after 40²=1600 is 41²=1681, which is 81 more, not 100. The one after that, 42²=1764, is 164 more. Neither is exactly 100 more, so the smallest perfect square total that is MORE than 100 extra is 1764 (an increase of 164), since no perfect square is exactly 1700." },
      { question: "How many small squares would a grid with 45 squares along each side contain in total?", answer: "45² = 2025 small squares." },
      { question: "Explain why simply adding a fixed number of squares (like 100) to a square grid's total does not usually result in another perfect square total.", answer: "Perfect squares are not evenly spaced -- the gap between consecutive perfect squares n² and (n+1)² is 2n+1, which keeps growing as n grows, so no single fixed number added will consistently jump from one perfect square to the next as n increases." }
    ]
  },
  {
    id: 19,
    ...
    subQuestions: [
      ...
      { question: "Verify that (5, 12, 13) is a genuine Pythagorean triple.", answer: "5²+12² = 25+144 = 169. 13² = 169. They match." },
      ...
      { question: "Verify (8, 15, 17) using the Pythagoras relation.", answer: "8²+15² = 64+225 = 289. 17² = 289. They match, confirming this is a valid triple for the ramp's dimensions." }
    ]
  },
  {
    id: 20,
    ...
    subQuestions: [
      { question: "Find the edge length of the 1331 cubic cm module.", answer: "1331 = 11³, so the edge is 11 cm." },
      { question: "Find the edge length of the 2197 cubic cm module.", answer: "2197 = 13³, so the edge is 13 cm." },
      { question: "Find the edge length of the 3375 cubic cm module.", answer: "3375 = 15³, so the edge is 15 cm.", options: ["14 cm", "15 cm", "16 cm", "17 cm"], correctIndex: 1 },
      { question: "The library wants to stack modules of the SAME size to build a single large cube shape with no gaps, using exactly 8 of the 11 cm modules. Is this possible, and if so, describe the arrangement.", answer: "Yes -- 8 identical small cubes can always be arranged as a 2x2x2 larger cube (since 2³=8 exactly), regardless of the individual module's own size, so 8 of the 11 cm modules form one large cube of edge 22 cm." }
    ]
  },
];
...
export const MATHS8SC_SELF_ASSESSMENT: QuizQuestion[] = [
  ...
  { id: 3, question: "The sum of the first 10 odd numbers equals:", options: ["81", "90", "100", "110"], correctAnswer: 2, explanation: "Sum of first n odd numbers = n². For n=10, that is 100." },
  { id: 4, question: "How many numbers lie between 9² and 10²?", options: ["16", "18", "20", "22"], correctAnswer: 1, explanation: "2n for n=9 gives 18." },
  { id: 5, question: "Using m=4 in (2m, m²-1, m²+1), the triple is:", options: ["(6,8,10)", "(8,15,17)", "(10,24,26)", "(12,35,37)"], correctAnswer: 1, explanation: "2(4)=8, 4²-1=15, 4²+1=17." },
  ...
  { id: 8, question: "Using prime factorization, sqrt(784) equals:", options: ["26", "27", "28", "29"], correctAnswer: 2, explanation: "784 = 2⁴ x 7², so sqrt = 2² x 7 = 28." },
  { id: 9, question: "The smallest number that must be multiplied to 45 to make it a perfect square is:", options: ["3", "5", "9", "15"], correctAnswer: 1, explanation: "45 = 3² x 5. The 5 is unpaired, so multiply by 5 to get 225 = 15²." },
  { id: 10, question: "The smallest number that must be divided from 32 to make it a perfect square is:", options: ["2", "4", "8", "16"], correctAnswer: 0, explanation: "32 = 2⁵. Dividing by 2 gives 2⁴ = 16, a perfect square." },
  { id: 11, question: "sqrt(6.25) equals:", options: ["2.5", "2.05", "0.25", "25"], correctAnswer: 0, explanation: "2.5 x 2.5 = 6.25." },
  { id: 12, question: "sqrt(120) lies between:", options: ["9 and 10", "10 and 11", "11 and 12", "12 and 13"], correctAnswer: 1, explanation: "10²=100 and 11²=121, and 120 falls between them." },
  ...
  { id: 15, question: "4³ is the sum of how many consecutive odd numbers?", options: ["3", "4", "5", "6"], correctAnswer: 1, explanation: "n³ is the sum of exactly n consecutive odd numbers -- here n=4." },
  { id: 16, question: "Using prime factorization, cbrt(4096) equals:", options: ["14", "15", "16", "17"], correctAnswer: 2, explanation: "4096 = 2¹², so cbrt = 2⁴ = 16." },
  { id: 17, question: "Using prime factorization, cbrt(6859) equals:", options: ["17", "18", "19", "20"], correctAnswer: 2, explanation: "6859 = 19³." },
  { id: 18, question: "The smallest number to multiply 108 by to make it a perfect cube is:", options: ["2", "3", "4", "6"], correctAnswer: 0, explanation: "108 = 2² x 3³. The exponent of 2 is 2, needing 1 more, so multiply by 2 to get 216 = 6³." },
  { id: 19, question: "A cube has volume 2197 cubic cm. Its edge length is:", options: ["11 cm", "12 cm", "13 cm", "14 cm"], correctAnswer: 2, explanation: "2197 = 13³." },
  { id: 20, question: "If a perfect cube ends in 9, its cube root ends in:", options: ["1", "3", "9", "7"], correctAnswer: 2, explanation: "The pairing matches 9 with 9 (since 9³=729, ending in 9)." },
  ...
  { id: 24, question: "Verify: which of these is a genuine Pythagorean triple?", options: ["(5,11,13)", "(7,24,25)", "(9,14,17)", "(6,10,12)"], correctAnswer: 1, explanation: "7²+24² = 49+576 = 625 = 25². The others fail this check." },
  ...
  { id: 28, question: "108 must be divided by which number to become a perfect square?", options: ["2", "3", "4", "9"], correctAnswer: 1, explanation: "108 = 2² x 3³. Dividing by 3 gives 36 = 6²." },
  { id: 29, question: "Which of these numbers is NOT a perfect cube?", options: ["343", "400", "512", "729"], correctAnswer: 1, explanation: "7³=343, 8³=512, 9³=729 are perfect cubes, but 400 is not." },
  { id: 30, question: "Estimating without a calculator, sqrt(200) is closest to:", options: ["13", "14", "15", "16"], correctAnswer: 1, explanation: "14²=196 and 15²=225. 200 is much closer to 196, so sqrt(200) is approximately 14.1." },
];
